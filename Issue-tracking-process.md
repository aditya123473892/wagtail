...
* A specific version number: the issue is important enough that it needs to be fixed in this version. There are actual resources and/or plans to work on the issue in the given version.
