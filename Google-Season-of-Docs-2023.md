...
- Work with our community organisers to adapt the tutorials for open source beginners, which will support programs and workshops like Outreachy, GSoC, and [Coders of Colour](https://codersofcolour.org/posts/introduction-to-wagtail-and-dev-ops-programme/).
